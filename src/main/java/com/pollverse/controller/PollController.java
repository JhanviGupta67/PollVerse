...
public class PollController {
    ...
    @PostMapping("/create")
    public String processCreatePoll(@ModelAttribute("poll") Poll poll,
                                    HttpSession session,
    ...
    public String viewPoll(@PathVariable int pollId, HttpSession session, Model model) {
    ...
    public String processVote(@PathVariable("pollId") int pollId,
