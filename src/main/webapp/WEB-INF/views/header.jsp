        ...
        <nav class="flex flex-col lg:flex-row lg:items-center lg:space-x-8 space-y-3 lg:space-y-0 w-full lg:w-auto text-center lg:text-right text-lg font-medium">
            ...
            <c:choose>
                <c:when test="${not empty sessionScope.username}">
                    <a href="${pageContext.request.contextPath}/user/logout" class="hover:text-gray-200 transition-colors duration-200 text-sm sm:text-base font-medium px-3 py-1 border border-white/20 rounded-md hover:bg-white/10">Logout</a>
                </c:when>
