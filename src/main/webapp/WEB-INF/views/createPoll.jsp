...
<body class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 min-h-screen">
    ...
    <!-- Main content -->
    <div class="flex items-center justify-center py-12 px-4 min-h-[calc(100vh-80px)]">
        <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-xl border border-white/20">
