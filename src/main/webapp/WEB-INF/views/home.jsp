...
<body class="bg-gradient-to-br from-blue-50 via-white to-indigo-50 min-h-screen">
    ...
    <footer class="bg-white border-t border-gray-200 mt-16">
        <div class="container mx-auto px-4 py-8 text-center text-gray-600">
            <p>&copy; 2025 PollVerse. All rights reserved. | <a href="${pageContext.request.contextPath}/about" class="hover:text-blue-600">About</a> | <a href="${pageContext.request.contextPath}/privacy" class="hover:text-blue-600">Privacy</a></p>
        </div>
    </footer>
</body>
</html>