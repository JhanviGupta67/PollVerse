            ...
            theme: {
                extend: {
                    ...
                    boxShadow: {
                        ...
                        'brand': '0 10px 30px -5px rgba(14, 165, 233, 0.4)', // Custom shadow for button
                    }
                }
            }
        }
...
<body class="min-h-screen flex items-center justify-center p-4 
    ...
    <div class="w-full max-w-lg bg-white p-10 shadow-xl rounded-3xl border border-gray-100 transform transition duration-500 hover:shadow-2xl hover:scale-[1.01] animate-in slide-in-from-top-10">
        
        <div class="text-center mb-8">
            <h2 class="text-4xl font-extrabold text-poll-primary-600 tracking-tight">
                Join <span class="text-poll-accent-500">PollVerse</span>
            </h2>
            <p class="text-gray-500 text-lg mt-1">Create your account in seconds!</p>
        </div>
